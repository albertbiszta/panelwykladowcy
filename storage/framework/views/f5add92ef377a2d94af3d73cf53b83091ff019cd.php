                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Imię i Nazwisko ')); ?></label>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            <label for="university" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Uczelnia')); ?></label>

                            <div class="col-md-6">
                                <input id="university" type="text" class="form-control <?php if ($errors->has('university')) :
if (isset($message)) { $messageCache = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aba\Desktop\LARAVEL ALL\panelwykladowcy\resources\views/auth/register.blade.php ENDPATH**/ ?>